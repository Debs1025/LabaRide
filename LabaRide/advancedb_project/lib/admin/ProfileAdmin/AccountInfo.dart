...
class _AccountInfoState extends State<AdminAccountInfo> {
  ...
  final Map<String, TextEditingController> _controllers = {
    'ID': TextEditingController(text: '#123456'),
    'Name': TextEditingController(text: 'John Doe'),
    'Username': TextEditingController(text: 'johndoe'),
    'Contact Number': TextEditingController(text: '+1234567890'),
    'Email Address': TextEditingController(text: 'john@example.com'),
    'Emergency Contact Number': TextEditingController(text: '+1234567890'),
  };

  // Add editing state trackers
            ...
            children: [
              ...
              if (isEditable)
                GestureDetector(
                  onTap: () {
                    setState(() {
                      _isEditing[label] = !_isEditing[label]!;
                    });
                  },
                  child: Padding(
