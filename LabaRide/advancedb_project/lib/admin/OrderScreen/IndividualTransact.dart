  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Order #${transactionData['customerId']!.substring(1)}',
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailItem('Customer ID', transactionData['customerId']!),
                _buildDetailItem('Recipient Name', transactionData['recipientName']!),
                
                const SizedBox(height: 24),
                _buildSectionTitle('Status Information'),
                _buildDetailItem('Status', transactionData['statusType']!),
                _buildDetailItem('Order Status', transactionData['orderStatus']!),
                ...
                _buildDetailItem('Payment Type', transactionData['paymentType']!),
                _buildDetailItem('Total Amount', transactionData['totalAmount']!),
                _buildDetailItem('Payment Status', transactionData['paymentStatus']!),
              ],
            ),
          ),
        ),
...
Widget _buildOrderDetailsCard() {
    final double totalAmount = double.parse(transactionData['totalAmount']!.replaceAll('₱', ''));
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(color: Colors.grey.shade200),
          const SizedBox(height: 12),
          _buildPriceRow('Order Total:', transactionData['totalAmount']!, isTotal: true),
        ],
      ),
    );
  }
